...
const Attendance = async () => {
  ...
  if (
    !session ||
    (session.user.role !== 'ADMIN' && session.user.role !== 'STAFF' && session.user.role !== 'ELECTED' && session.user.role !== 'NOMINATED')
  ) {
    return (
            ...
            <div className="flex flex-col items-center space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="text-lg font-medium text-gray-600">
                  Must be a Party Staff or Leader to view this page!
                </p>
                <Link
                  href="/login"
