...
const links = [
  ...
  { name: 'About Us', href: '/about', icon: RxDashboard },
  { name: 'Get Involved', href: '/about/getInvolved', icon: GrGrow },
  {
      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              'flex h-[48px] grow items-center justify-center gap-2 overflow-hidden rounded-md p-3 text-sm font-medium transition-transform duration-300 md:flex-none md:justify-start md:p-2 md:px-3',
              {
