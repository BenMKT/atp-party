    ...
    <form action={dispatch} className="space-y-3">
      <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
        <h1 className={`${lusitana.className} mb-3 text-2xl`}>
          Already a member!!<br></br>Please login to continue...
        </h1>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <HiOutlineIdentification className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
            </div>
          </div>
          <div className="mt-4">
            <label
        ...
        <LoginButton />
        <span className="mb-3 mt-5 block text-center text-xs font-medium text-gray-900">
          OR
        </span>
