      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {session && (
          <motion.div
            ...
            className={`${lusitana.className} absolute flex items-center gap-1 p-2 font-semibold md:text-white`}
          >
        ...
        <div className="flex flex-1 flex-col-reverse overflow-hidden md:flex-row">
          ...
          >
            <motion.h1
              ...
              initial={{ opacity: 0, y: '-100vw' }} // Start with 0 opacity and -100px on the x-axis
              animate={{ opacity: 1, y: 0 }} // Animate to full opacity and x-axis to 0
              transition={{
                type: 'spring',
                stiffness: 120,
                damping: 12,
